...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "mazacoin.conf") + "\n";
...
#ifndef WIN32
    strUsage += "  -pid=<file>            " + strprintf(_("Specify pid file (default: %s)"), "mazacoind.pid") + "\n";
#endif
...
{
    return FormatParagraph(strprintf(_("Copyright (C) 2013-%i The Mazacoin Developers"), COPYRIGHT_YEAR)) + "\n" +
           "\n" +
